...
import logo from "./utils/solobo.png";
import logo1 from "./utils/removed.png";
import logo2 from "./utils/somacaco.png";
import './styles.css';
      ...
      <div className="container mt-4">
        <div className="row ps-5">
          <div className="col d-flex align-items-center">
            <img src={logo} width="100" height="100" style={{ background: 'none' }} alt="Logo guara" />
            <h2 className="lead fw-bold">Our Mission</h2>
          </div>
        </div>
        <div className="row ps-5">
          <div className="col">
        ...
        <div className="row ps-5 my-4">
          <div className="col d-flex align-items-center">
            <img src={logo1} width="100" style={{ background: 'none' }} alt="Capivara" />
            <h2 className="lead fw-bold">Innovation and Originality</h2>
          </div>
        </div>
        <div className="row ps-5">
          <div className="col">
        ...
        <div className="row ps-5 my-4">
          <div className="col d-flex align-items-center">
            <img src={logo2} width="100" style={{ background: 'none' }} alt="Urso" />
            <h2 className="lead fw-bold">Advantages and Differentiation</h2>
          </div>
        </div>
        <div className="row ps-5">
          <div className="col">
